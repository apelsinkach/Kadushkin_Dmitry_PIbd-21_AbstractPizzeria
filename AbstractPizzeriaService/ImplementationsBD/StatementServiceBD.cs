...
{
    public class StatementServiceBD : IStatementService
    {
        private AbstractDbContext context;

        public StatementServiceBD(AbstractDbContext context)
        {
        ...
        public List<ResourcesLoadViewModel> GetStocksLoad()
        {
            return context.Resources
                            .ToList()
                            .GroupJoin(
                                    context.ResourceIngridients
                                                .Include(r => r.Ingridient)
                                                .ToList(),
                                    stock => stock,
                                    stockComponent => stockComponent.Resource,
                                    (stock, stockCompList) =>
            new ResourcesLoadViewModel
            {
        ...
        public List<CustomerRequestsModel> GetClientOrders(StatementBindingModel model)
        {
